...
SoundLight.User.prototype.getInfo = function() {
    Phink.Rest.get('/api/user/' + this.currentUser, function(data) {
...
SoundLight.Collection.prototype.fetch = function(callback) {
    Phink.Rest.get('/api/collection', function(data) {
...
SoundLight.Playlist.prototype.getFavorites = function(callback) {
    var the = this;
    Phink.Rest.get('/api/playlist/' + this.currentUser, function(data) {
        if(typeof callback === 'function') {
...
SoundLight.Playlist.prototype.addTrack = function(trackId) {
    var the = this;
    Phink.Rest.put('/api/playlist/' + this.currentPlaylist, {'track' : trackId}, function(data) {
        if(data.inserted == 1) {
            the.afterAddTrack();
        }
    });
...
SoundLight.Playlist.prototype.removeTrack = function(trackId) {
    var the = this;
    Phink.Rest.delete('/api/playlist/' + trackId, function(data) {
        if(data.deleted == 1) {
